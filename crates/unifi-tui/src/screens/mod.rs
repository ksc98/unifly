...
pub fn create_screens() -> Vec<(ScreenId, Box<dyn Component>)> {
    vec![
        (ScreenId::Dashboard, Box::new(dashboard::DashboardScreen::new())),
        (ScreenId::Devices, Box::new(devices::DevicesScreen::new())),
        (ScreenId::Clients, Box::new(clients::ClientsScreen::new())),
        (ScreenId::Networks, Box::new(networks::NetworksScreen::new())),
        (ScreenId::Firewall, Box::new(firewall::FirewallScreen::new())),
        (ScreenId::Topology, Box::new(topology::TopologyScreen::new())),
